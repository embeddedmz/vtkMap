...
=========================================================================*/
// .NAME vtkMultiThreadedBingLayer - Multithreaded Bing layer
// .SECTION Description
// A multithreaded subclass of vtkBingLayer.
...
#ifndef __vtkMultiThreadedBingLayer_h
#define __vtkMultiThreadedBingLayer_h
...
class VTKMAPCORE_EXPORT vtkMultiThreadedBingLayer : public vtkBingLayer
{
public:
  static vtkMultiThreadedBingLayer* New();
  vtkTypeMacro(vtkMultiThreadedBingLayer,
    vtkBingLayer) void PrintSelf(ostream& os, vtkIndent indent) override;
...
protected:
  vtkMultiThreadedBingLayer();
  ~vtkMultiThreadedBingLayer() override;
  ...
  class vtkMultiThreadedBingLayerInternals;
  vtkMultiThreadedBingLayerInternals* Internals;

private:
  vtkMultiThreadedBingLayer(
    const vtkMultiThreadedBingLayer&);              // Not implemented
  void operator=(const vtkMultiThreadedBingLayer&); // Not implemented
};

#endif // __vtkMultiThreadedBingLayer_h
