/*=========================================================================
  ...
  Module:    vtkMultiThreadedBingLayer.cxx
...
#include "vtkMultiThreadedBingLayer.h"
...
vtkStandardNewMacro(vtkMultiThreadedBingLayer)

  //----------------------------------------------------------------------------
  class vtkMultiThreadedBingLayer::vtkMultiThreadedBingLayerInternals
{
public:
...
{
  vtkMultiThreadedBingLayer* self;
  vtkMultiThreader::ThreadInfo* info =
    static_cast<vtkMultiThreader::ThreadInfo*>(arg);
  self = static_cast<vtkMultiThreadedBingLayer*>(info->UserData);
...
//----------------------------------------------------------------------------
vtkMultiThreadedBingLayer::vtkMultiThreadedBingLayer()
{
  this->AsyncMode = true;
  this->Internals = new vtkMultiThreadedBingLayerInternals;
...
//----------------------------------------------------------------------------
void vtkMultiThreadedBingLayer::PrintSelf(ostream& os, vtkIndent indent)
{
  Superclass::PrintSelf(os, indent);
  os << "vtkMultiThreadedBingLayer"
     << "\n"
...
//----------------------------------------------------------------------------
void vtkMultiThreadedBingLayer::Update()
{
  vtkBingLayer::Update();
}

//----------------------------------------------------------------------------
void vtkMultiThreadedBingLayer::BackgroundThreadExecute()
{
...
void vtkMultiThreadedBingLayer::RequestThreadExecute(int threadId)
{
...
//----------------------------------------------------------------------------
vtkMap::AsyncState vtkMultiThreadedBingLayer::ResolveAsync()
{
  // Check for new tiles
  TileSpecList newTiles;
...
//----------------------------------------------------------------------------
void vtkMultiThreadedBingLayer::AddTiles()
{
  if (!this->Renderer)
  {
    return;
...
//----------------------------------------------------------------------------
vtkSmartPointer<vtkMapTile> vtkMultiThreadedBingLayer::CreateTile(
...
//----------------------------------------------------------------------------
void vtkMultiThreadedBingLayer::AssignTileSpecsToThreads(
  TileSpecList& tileSpecs)
{
...
//----------------------------------------------------------------------------
void vtkMultiThreadedBingLayer::AssignOneTileSpecPerThread(
  TileSpecList& tileSpecs)
{
...
void vtkMultiThreadedBingLayer::CollateThreadResults(TileSpecList& newTiles,
  TileSpecList& tileSpecs)
{
  int numThreads = this->Internals->RequestThreader->GetNumberOfThreads();
  for (int i = 0; i < numThreads; i++)
...
//----------------------------------------------------------------------------
void vtkMultiThreadedBingLayer::UpdateNewTiles(TileSpecList& newTiles)
{
  if (newTiles.empty())
  {
    return;
